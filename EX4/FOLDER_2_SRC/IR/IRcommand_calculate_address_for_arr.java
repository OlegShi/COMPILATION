...
public class IRcommand_calculate_address_for_arr extends IRcommand{
  ...
  String index_is_inbound_label;
	...
	public IRcommand_calculate_address_for_arr(TEMP return_value,TEMP offset, TEMP heap_pointer)
	{
  ...
  //calculate address
   ...
   //t0 = element_size
      ...
      sir_MIPS_a_lot.getInstance().li(t0,sir_MIPS_a_lot.WORD_SIZE);
