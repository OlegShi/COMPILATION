...
public class SYMBOL_TABLE
{
    ...
    private static int nScopeDepth = 0;
	...
	public void enter(String name,TYPE t)
	{
		...
		/**************************************************************************/
		SYMBOL_TABLE_ENTRY e = new SYMBOL_TABLE_ENTRY(name,t,hashValue,next,top,top_index++, nScopeDepth);
 ...
 public SYMBOL_TABLE_ENTRY getEntry(String name){
     SYMBOL_TABLE_ENTRY e;
   ...
   return null;
	...
	//Oleg
	/******************************************/
	/* return the scope of element with name */
	/****************************************/
	public int getElementScope(String name)
	{
		SYMBOL_TABLE_ENTRY e;
	...
	/*****************************/
	public static int getCurrScope()
	{
			return nScopeDepth;
	}
	...
	public void beginScope()
	{
        ...
        // Update the Scope Depth counter
        ++nScopeDepth;
		...
		/*********************************************/
		//PrintMe();
   //not needed, it is printed in enter
	}
